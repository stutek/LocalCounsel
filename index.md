...
| [/docs/longevity-coach/TODO-dify-local-gemma](/docs/longevity-coach/TODO-dify-local-gemma.md) | Requirements & Implementation Backlog | MVP backlog for the Dify.ai + local Gemma 4 BIA flow: encrypted Takeout ingestion, idempotent openEHR import, and a human-reviewed frontier handoff. |
